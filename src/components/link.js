export function createSpanWithText(text) {
  ...
  span.className =
    "text-gray-700 font-medium mt-3 group-hover:text-gray-900 transition duration-300";
  span.innerText = text;
...
export function createDiv(divClassname) {
  const classNameDiv =
    divClassname ||
    "p-8 grid grid-cols-3 rounded-lg shadow-lg hover:bg-gray-700 transition duration-300 bg-gray-400";
